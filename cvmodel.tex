...
\firstname{Mikael}
\familyname{Trellet}
\title{Postdoc researcher in Bioinformatics engineering}              
\address{Godfried van Seijstlaan}{3703 BR ZEIST}    
\email{mikael.trellet@gmail.com}                      
\homepage{https://perso.limsi.fr/trellet/}
\mobile{+33 6 50 60 71 72} 
...
\subsection{Research}
\cventry{Oct. 2012 -- Dec. 2015}{PhD student}{VENISE group, LIMSI/CNRS}{Paris-Saclay University - FRANCE}{}{Exploration and Analyses of Molecular Data in Virtual Environments. 
\begin{itemize}
